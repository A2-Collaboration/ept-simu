...
c      
     ...
     &  emin,emax,estep,alpha,track(2,300),start
      integer it,i
c
      pi=3.1415926
      ...
      it=10
      e=1500.
      x0=5.40   ! Eintrittspunkt an Feldkante
      z0=11.6
      a00=78.
      emin=10.
      emax=160.
...
1     print*,'Eingabe Inkrement l/Index, Iterationen it'
      ...
      a0=a00/180*pi
      start=11.5
      print*,'Startpunkt */cm vor Feldkante [',start,']:'
      read*,start
      z0=11.6-start/1.1055
      x0=(z0+13.81)/tan(a0)
 ...
 101    format(1x,'    *    *    *    *')
      ...
      print*,'Gesamtergebnis fuer Trajektorien in fort.30'
